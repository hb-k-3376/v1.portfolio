  ...
  return (
    <Section id="about">
      ...
      <div aria-labelledby="about-heading">
        ...
        <p>
          안녕하세요, 프론트엔드 개발자 <strong>김현빈</strong>입니다. 백엔드 개발자로
          2년간 일하던 중, 우연한 기회로 리액트 프로젝트를 경험하게 되었습니다. 사용자와
          직접 소통하는 듯한 느낌, 구현한 기능이 즉각적으로 화면에 나타나며 빠른 피드백을
          받는 과정이 저를 사로잡았습니다. 프론트엔드의 매력에 완전히 빠져들었고, 전환을
          결심했습니다. 끈기있고 열정적으로 학습하며 프로그래머스 데브코스를 수료했고,
          2차, 3차 프로젝트를 거쳐 백엔드 팀과 협업하는 마지막 4차 프로젝트에서{' '}
          <strong>최우수상</strong>을 받았습니다.
        </p>
        <br />
        <p>
          이 성과에는 제 가장 큰 강점인 <strong>커뮤니케이션</strong>이 큰 역할을 했다고
          생각합니다. 저는 사람들과 대화를 나누고 의견을 공유하며 토론하는 것을
          좋아합니다.{' '}
          <strong>
