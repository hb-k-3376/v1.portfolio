    ...
    <Section id="about">
      ...
      <div aria-labelledby="about-heading" className="mb-6 flex flex-col gap-2.5">
        ...
        <p>
          ...
          데브코스를 수료하며 2차·3차·4차 프로젝트 모두 <Highlight>최우수상</Highlight>을
          받을 만큼 몰입하고 노력했습니다. 구현한 기능이 즉각적으로 화면에 나타나는
          프론트엔드의 매력에 빠져들었고, 빠르게 성장하고 있습니다.
        </p>
        <p>
          ...
          과정을 즐깁니다. 특히 <Highlight>2년간 풀스택 실무 경험</Highlight>이 있어 API
          설계와 데이터 흐름을 이해하고 있어, 백엔드 팀과 원활히 소통하는 데 도움이
          되었습니다.{' '}
        </p>
        <p>
          개발할 때는 <Highlight>사용자 경험</Highlight>을 최우선으로 생각합니다. 단순히
          기능을 구현하는 것을 넘어, 사용자의 입장에서 깊이 있게 고민하고 더 나은 경험을
          제공하려 노력합니다.{' '}
          <Highlight>
