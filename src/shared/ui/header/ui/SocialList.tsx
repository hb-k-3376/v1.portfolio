    ...
    <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
      ...
      <li className="mr-5 shrink-0 text-xs">
        <ExternalLink
          ...
          className="block hover:text-primary focus-visible:text-primary"
        >
          <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 448 512" fill="currentColor">
      ...
      <li className="mr-5 shrink-0 text-xs">
        <ExternalLink
          ...
          className="block hover:text-primary focus-visible:text-primary"
        >
          <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 512 512" fill="currentColor">
      ...
      <li className="mr-5 shrink-0 text-xs">
        <ExternalLink
          ...
          title="Leet Code"
          className="block hover:text-primary focus-visible:text-primary m-auto"
        >
